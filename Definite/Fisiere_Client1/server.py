...
class Server:
    ...
    def start(self):
        ...
        while True:
            ...
            # Creare thread separat pentru fiecare conexiune client-server
            ...
            try:
                ...
                if data:
                    ...
                    if request["type"] == "publish":
                        ...
                        for client in self.clients:
                            if client.client_socket == client_socket:
                                client.files.append(request["file"])
                        ...
                        for client in self.clients:
                            if client.client_socket != client_socket:
                                notification = {"type": "file_add", "name": client_name, "file": request["file"]}
                                client.client_socket.sendall(pickle.dumps(notification))
